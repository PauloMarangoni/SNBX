...
namespace SNBX::RenderDevice
{
	...
	SNBX_API RenderPipelineState    CreateGraphicsPipelineState(const GraphicsPipelineCreation& graphicsPipelineCreation);

	SNBX_API void                   DestroyGraphicsPipelineState(RenderPipelineState pipelineState);
